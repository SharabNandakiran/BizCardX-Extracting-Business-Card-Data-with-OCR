...
icon = Image.open("iconb.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Nanda Kiran",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Nanda Kiran*!"""})

st.sidebar.header(":wave: :blue[**Hello! Welcome to the Bizcard**]")

# SETTING-UP BACKGROUND IMAGE
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://t3.ftcdn.net/jpg/01/35/13/12/240_F_135131278_G10RvGug7xQUNJh1O6uicf9JJ7myoHbv.jpg");
...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Upload & Extract","Modify"], 
                       ...
                       default_index=0,
                       styles={"nav-link": {"font-size": "15px", "text-align": "left", "margin": "-2px", "--hover-color": "#6495ED"},
                               "icon": {"font-size": "15px"},
